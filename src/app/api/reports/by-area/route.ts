...
// GET /api/reports/by-area - Stats by area
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error getting stats by area:', error)
    return NextResponse.json({ error: 'Error al obtener estadísticas por área' }, { status: 500 })
  }
}
